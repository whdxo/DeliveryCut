...
전체 프로젝트 문서는 `claude/프로젝트문서/` 폴더에서 확인하세요.

- [프로젝트 개요](claude/프로젝트문서/1.기획/1.1-프로젝트-개요.md)
- [시스템 아키텍처](claude/프로젝트문서/2.기술설계/2.1-시스템-아키텍처.md)
...
| 역할 | 담당 | 주요 업무 |
|------|------|-----------|
| **FE-1** | TBD | 입력 화면, 메뉴 카드 UI, 공통 컴포넌트 |
| **FE-2** | TBD | 레시피/플랜/장보기 UI, 저장/공유 UX |
| **BE** | TBD | API 구현, DB 설계, 배포 |
| **AI** | TBD | 프롬프트 설계, JSON 스키마, 품질 튜닝 |
