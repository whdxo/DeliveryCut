        ...
        <div className="w-full max-w-md">
          <div className="bg-dc-surface rounded-2xl border border-dc-border p-8 flex flex-col gap-6 shadow-sm">
            <div className="flex flex-col gap-2 text-center">
              <h1 className="text-dc-text text-2xl font-bold">회원가입</h1>
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-dc-text-muted text-xs">또는 이메일로 가입</span>
              <div className="flex-1 h-px bg-dc-border" />
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2">
                <label className="text-dc-text text-sm font-medium">비밀번호 확인</label>
                <input
                  type="password"
            ...
            <div className="text-center text-sm text-dc-text-secondary">
              이미 계정이 있으신가요?{" "}
              <Link href="/login" className="text-dc-primary font-medium hover:underline">
                로그인
              </Link>
            </div>
          </div>
